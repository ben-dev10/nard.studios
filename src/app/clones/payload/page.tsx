...
import { GithubLogo } from "@/components/_ui/icons";
import { Button } from "@/components/ui/button";
// import { SheetMinify } from "../../sections/navbar/navbar-sheets/sheet--minify";
      ...
      >
        <div className="_header--cta grid md:col-span-4 md:items-center">
          <div className="wrapper">
            <h1 className="font-UntitledSansB mb-5 !text-3xl text-balance sm:text-4xl md:w-[150%] lg:text-5xl">
    ...
    <Section.RootElement className="px-[var(--gutter-h)]">
      <Section.Container container="none" className="">
        <div className="_contents flex flex-col md:items-center">
          ...
          <div className="_logo-grid h-[calc(var(--column)*4)] md:h-[calc(var(--column)*2)] w-full grid grid-cols-8 md:grid-cols-16 mt-10">
  ...
  return (
    <Section.RootElement className="pb-15">
      <Section.Container
        ...
        container="none"
      >
        <h2 className="font-UntitledSansB text-center">
...
const TestimonialCard = ({
  ...
  return (
    <div
      className={`${className} _testimonial-card group border-y border-l relative w-full md:w-1/2 flex !h-full flex-col p-8 shrink-0 grow-0 snap-always snap-start bg-black`}
    >
  ...
  return (
    <Section.RootElement className="bg-black py-10 lg:pt-20">
      <Section.Container container="none" className="px-[var(--gutter-h)]">
        <h3 className="font-UntitledSansB">
      ...
      <Section.Container
        container="none"
        className="_carousel scrollbar-hide relative z-4 flex h-[var(--card-height)] snap-x scroll-pl-[var(--gutter-h)] overflow-x-scroll overflow-visible px-[var(--gutter-h)] py-10 [--card-height:30rem]"
      >
...
export default function PayloadCMS() {
  return (
    <div className="_app.payload !top-0 !left-0 relative overflow-hidden text-white [--border:#fff]/15">
      <Background>
        <Background.Texture
